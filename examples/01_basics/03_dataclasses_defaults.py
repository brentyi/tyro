...
.. warning::
    ...
    :code:`__post_init__` would be called for both the :code:`Args()` object
    provided as a default value and as an output from :func:`tyro.cli()`.
    Instead, we show below one example of how derived fields can be defined
    immutably.
