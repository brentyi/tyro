...
.. raw:: html
        ...
        <kbd>python 04_additional/01_positional_args.py --help</kbd>

.. program-output:: python ../../examples/04_additional/01_positional_args.py --help

------------

.. raw:: html

        <kbd>python 04_additional/01_positional_args.py ./a ./b --optimizer.learning-rate 1e-5</kbd>

.. program-output:: python ../../examples/04_additional/01_positional_args.py ./a ./b --optimizer.learning-rate 1e-5
