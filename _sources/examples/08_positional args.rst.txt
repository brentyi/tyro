...
.. raw:: html
        ...
        <kbd>python 08_positional_args.py --help</kbd>

.. program-output:: python ../../examples/08_positional_args.py --help

------------

.. raw:: html

        <kbd>python 08_positional_args.py ./a ./b --optimizer.learning-rate 1e-5</kbd>

.. program-output:: python ../../examples/08_positional_args.py ./a ./b --optimizer.learning-rate 1e-5
