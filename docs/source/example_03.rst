...
.. command-output:: python ../../examples/03_enums_and_containers.py --help

.. command-output:: python ../../examples/03_enums_and_containers.py --dataset-sources ./data --image-dimensions 16 16

.. command-output:: python ../../examples/03_enums_and_containers.py --dataset-sources ./data --optimizer-type SGD
