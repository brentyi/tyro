...
.. command-output:: python ../../examples/05_hierarchical_configs.py --help

.. command-output:: python ../../examples/05_hierarchical_configs.py --out-dir . --config.optimizer.algorithm SGD

.. command-output:: python ../../examples/05_hierarchical_configs.py --out-dir . --restore-checkpoint
