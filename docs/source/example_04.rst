...
.. command-output:: python ../../examples/04_flags.py --help

.. command-output:: python ../../examples/04_flags.py --boolean True

.. command-output:: python ../../examples/04_flags.py --boolean False --flag-a

.. command-output:: python ../../examples/04_flags.py --boolean False --no-flag-b
