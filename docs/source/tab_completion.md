...
`--tyro-print-completion {bash/zsh/tcsh}` flag to a tyro CLI. This generates
...
python 01_functions.py --tyro-print-completion zsh > ~/.zfunc/_01_functions_py
```
...
python 01_functions.py --tyro-print-completion bash > ${completion_dir}/01_functions.py
```
