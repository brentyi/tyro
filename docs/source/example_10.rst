...
.. command-output:: python ../../examples/10_multiple_subparsers.py

.. command-output:: python ../../examples/10_multiple_subparsers.py --help

.. command-output:: python ../../examples/10_multiple_subparsers.py mnist-dataset --help

.. command-output:: python ../../examples/10_multiple_subparsers.py mnist-dataset adam-optimizer --optimizer.learning-rate 3e-4
