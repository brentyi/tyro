...
def test_generic_type_alias_individual_resolution() -> None:
    ...
    resolved_int = TypeParamResolver.resolve_type_params(alias_int)  # type: ignore
    resolved_bool = TypeParamResolver.resolve_type_params(alias_bool)  # type: ignore
...
def test_generic_type_alias_union_resolution() -> None:
    ...
    resolved_union = TypeParamResolver.resolve_type_params(union_type)  # type: ignore
