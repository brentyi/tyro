...
pytestmark = pytest.mark.skipif(
    sys.version_info <= (3, 10), reason="collections.abc.Callable requires Python > 3.10"
)

# Import collections.abc.Callable for Python > 3.10
if sys.version_info > (3, 10):
    from collections.abc import Callable
else:
    # Fallback import to avoid import errors during collection
